...
export default function Home() {
  return (
    <main>
      ...
      <section className="intro section"><p className="sectionLabel">ONE-STOP SERVICE</p><div className="introGrid"><h2>仕分け前の状態から、<br />現場ごとまとめて相談。</h2><p>機械や金属だけを選び出す必要はありません。倉庫や工場、事業所に残った品物を、そのままの状態からご相談いただけます。片付けや搬出、小規模な建物の解体も含めて対応します。</p></div></section>
      ...
      <section className="photoStory section"><div className="storyImage"><img src={asset("mixed-tools.jpg")} alt="まとめて置かれた草刈機やポンプなどの機械類" /></div><div className="storyCopy"><p className="sectionLabel">AS-IS IS OK</p><h2>古い、動かない、<br />種類が分からない。<br /><em>そのままで大丈夫です。</em></h2><p>サビている物、長年置いたままの物、大量にある物も、写真や現地の状況から確認します。掲載されていない品物も、まずは写真やお電話でご相談ください。</p><a href="mailto:cizeng4777@icloud.com?subject=写真査定の相談">写真を送って相談する →</a></div></section>
