...
export default function Home() {
  return (
    <main>
      ...
      <section className="work section" id="work"><div className="sectionHead"><p>WORK EXAMPLES</p><h2>片付け・解体のご相談例</h2><span>建物の状態、規模、周辺環境を確認して対応可否をご案内します。</span></div><div className="workGrid"><article><img src={asset("warehouse-frame.jpg")} alt="屋根と外壁を取り外した鉄骨倉庫" /><div><b>倉庫・作業小屋</b><p>戸建住宅の解体は行っていません。倉庫や作業小屋など、対応可能な規模を個別に確認します。</p></div></article><article><img src={asset("greenhouse.jpg")} alt="ビニールを外した農業用ハウスの骨組み" /><div><b>ビニールハウス</b><p>解体・撤去を相談できます。状態の良いハウスは、買取できる場合もあります。</p></div></article></div></section>

      <section className="caseStudy section"><div className="sectionHead"><p>CASE STUDY</p><h2>倉庫解体の作業例</h2><span>実際に対応した倉庫を、外装から骨組みへ順に解体していく様子です。</span></div><div className="caseGrid"><figure><img src={asset("warehouse-before.jpg")} alt="解体前の倉庫" /><figcaption><b>01</b><strong>解体前</strong></figcaption></figure><figure><img src={asset("warehouse-progress.jpg")} alt="外壁を取り外している倉庫" /><figcaption><b>02</b><strong>外装の取り外し</strong></figcaption></figure><figure><img src={asset("warehouse-work.jpg")} alt="外壁を取り外した倉庫" /><figcaption><b>03</b><strong>骨組みの状態へ</strong></figcaption></figure><figure><img src={asset("warehouse-frame.jpg")} alt="屋根材を取り外した倉庫" /><figcaption><b>04</b><strong>解体・分別を進行</strong></figcaption></figure></div></section>

      <section className="photoStory section"><div className="storyImage"><img src={asset("mixed-tools.jpg")} alt="古い草刈機やポンプなどの機械類" /></div><div className="storyCopy"><p className="sectionLabel">AS-IS IS OK</p><h2>古い、動かない、<br />種類が分からない。<br /><em>そのままで大丈夫です。</em></h2><p>サビている物、長年置いたままの物、大量にある物も、写真や現地の状況から確認します。掲載されていない品物も、まずは写真やお電話でご相談ください。</p><a href="mailto:hachiojishoji@gmail.com?subject=写真査定の相談">写真を送って相談する →</a></div></section>
      ...
      <section className="contact" id="company"><div><p>まずはお気軽にご相談ください</p><h2>売れるか分からない物も、<br />写真や電話から相談できます。</h2><div className="contactButtons"><a href="tel:08048544777"><small>電話受付</small>080-4854-4777</a><a className="mailButton" href="mailto:hachiojishoji@gmail.com?subject=買取・片付けの相談"><small>写真添付も歓迎</small>メールで相談する</a></div></div><aside><h3>合同会社八王子商事</h3><dl><dt>法人番号</dt><dd>8450003002544</dd><dt>法人番号指定日</dt><dd>2024年10月1日</dd><dt>代表者</dt><dd>池増龍一</dd><dt>電話</dt><dd>080-4854-4777</dd><dt>メール</dt><dd><a href="mailto:hachiojishoji@gmail.com">hachiojishoji@gmail.com</a></dd><dt>本店所在地</dt><dd>北海道深川市湯内1710-1</dd><dt>新潟拠点</dt><dd>新潟県上越市小泉615</dd><dt>許可</dt><dd>金属くず回収業者<br />北海道公安委員会許可 （金）第123080000017号<br /><br />古物商<br />栃木県公安委員会許可 第411080000986号</dd></dl></aside></section>
